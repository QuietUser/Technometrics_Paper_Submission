...
for (t in 9){
  for (a in 1){
    ...
    mtext("Downward Jump Needed to Achieve 80% Identification - AICc on Trend 9", side = 3, line = -3, outer = TRUE,font=2)
...
\newpage
Figures and Table Results in Section 6 
...
for (cn in c(170,446)){
  ...
  model.bayes <- hybrid.smoother.bayes(x,y,n.chain=1,chain.length=3000, burn.in.percent = 1/2, lambda2.mn0 = .05)
